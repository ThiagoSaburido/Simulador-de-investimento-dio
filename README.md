...
![Banner Sabu Invest](images/banner_sabu_invest.png)
...
Este projeto foi desenvolvido como parte do desafio de código **"Entendendo Desafio"** da [DIO (Digital Innovation One)](https://www.dio.me/).
...
1. Baixe o arquivo [`Simulador_Investimentos_FII.xlsx`](Simulador_Investimentos_FII.xlsx);
2. Abra no Excel, Google Sheets ou LibreOffice Calc;
3. Edite as células amarelas (Valor Inicial, Aporte Mensal, Dividend Yield e Valorização da Cota) com os dados do seu cenário;
4. Acompanhe o resumo automático e a tabela mês a mês para entender a evolução do seu patrimônio;
5. Use os resultados como referência para planejar seus próprios aportes em FIIs.
...
Projeto desenvolvido durante o desafio de código da [DIO (Digital Innovation One)](https://www.dio.me/), como prática dos conceitos de Excel aplicados a simulações financeiras.
